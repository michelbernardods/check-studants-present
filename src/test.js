...
const matriculas_cadastradas = fs.readFileSync(
'./files/matriculas.txt', 'utf8')
...
alunos = alunos.map(matricula_aluno => matricula_aluno.replace(" ","") && matricula_aluno.trimLeft())
